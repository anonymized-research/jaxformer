...
_CHECKPOINT_FOR_DOC = "anonmized/codegen-2B-mono"
_CONFIG_FOR_DOC = "CodeGenConfig"
_TOKENIZER_FOR_DOC = "GPT2Tokenizer"


CODEGEN_PRETRAINED_MODEL_ARCHIVE_LIST = [
    "anonmized/codegen-350M-nl",
    "anonmized/codegen-350M-multi",
    "anonmized/codegen-350M-mono",
    "anonmized/codegen-2B-nl",
    "anonmized/codegen-2B-multi",
    "anonmized/codegen-2B-mono",
    "anonmized/codegen-6B-nl",
    "anonmized/codegen-6B-multi",
    "anonmized/codegen-6B-mono",
    "anonmized/codegen-16B-nl",
    "anonmized/codegen-16B-multi",
    "anonmized/codegen-16B-mono",
...
class CodeGenAttention(nn.Module):
    ...
    def forward(
        ...
        # TODO(anonymized): factor out number of logical TPU-v4 cores or make forward pass agnostic
        # mp_num = 4
        mp_num = 8
