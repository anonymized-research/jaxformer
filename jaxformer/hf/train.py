...
def create_args(args=argparse.Namespace()):
    ...
    args.model = 'anonmized/codegen-16B-mono'

    args.deepspeed_config = DEEPSPEED_CONFIG

    args.data_train_set = 'gs://tpu-us-east1-research/anonymized/gptc/datasets/thepile/train/*.tfrecords'
...
def train(args):
    ...
    with print_time('Initializing model'):
        ...
        model.train()
        # TODO(anonymized): we need to set this flag twice?
