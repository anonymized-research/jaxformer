...
# TODO(anonymized): for inter-board sharding, we only need to serialize one copy
...
# TODO(anonymized): for inter-board sharding, we only need to de-serialize one copy
