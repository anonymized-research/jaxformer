...
def create_model(config):
    ...
    optimizer = optax.chain(
        ...
        # TODO(anonymized): make sure this is jnp.where() in https://github.com/deepmind/optax/blob/3d666d92211dc0e2689c3acf82656d6286952733/optax/_src/clipping.py#L100
...
def loss(vocab_size, logits, y, z_loss=1e-4):
    ...
    # TODO(anonymized): in theory, this should improve numerical stability. However, (1) causes issues with the magnitude of gradient over time, (2) causes NaN on TPU-v3.
    # (1)
