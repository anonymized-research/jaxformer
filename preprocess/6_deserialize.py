...
def create_args(args=argparse.Namespace()):
    ...
    args.data_in = 'gs://tpu-prem2-bucket/anonymized/data_protein_v3/5_shuffe_concat_eos/data_000000000000.tfrecords'
    args.tokenizer_file = 'gs://tpu-us-east1-research/anonymized/protein/data_protein_v2/tokenizer.json'
    # args.ds_prefetch = 8
